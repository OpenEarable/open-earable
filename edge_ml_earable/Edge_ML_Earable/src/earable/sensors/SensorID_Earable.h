...
const int IMU_MAP[] = {IMU_ACCELERATION, IMU_GYROSCOPE};
...
const int FLOAT_TYPE_COUNT = 4;
const int RETURN_TYPE_INT[] = {};
const int RETURN_TYPE_FLOAT[] = {IMU_ACCELERATION, IMU_GYROSCOPE, BARO_PRESSURE, BARO_TEMP};

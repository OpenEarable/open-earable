...
TwoWire::TwoWire(NRF_TWIM_Type * p_twim, NRF_TWIS_Type * p_twis, IRQn_Type IRQn, uint8_t pinSDA, uint8_t pinSCL)
{
  ...
  this->_p_twis = p_twis;
  this->_IRQn = IRQn;
  this->_uc_pinSDA = digitalPinToPinName(pinSDA);
  this->_uc_pinSCL = digitalPinToPinName(pinSCL);
...
#if WIRE_HOWMANY > 2
TwoWire Wire2(NRF_TWIM1, NRF_TWIS2, SPIM2_SPIS2_TWIM2_TWIS2_SPI1_TWI2_IRQn, PIN_WIRE_SDA2, PIN_WIRE_SCL2);
#endif
